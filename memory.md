...
* **Backend**: **Node.js** with an **Express 5** server ([`EBWaterWebsite/server.js`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/server.js)):
...
The visual design is grounded in the brand specification found in [`EBWaterWebsite/5f450983-03f3-4c6a-b090-3bf05086417a.jpg`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/5f450983-03f3-4c6a-b090-3bf05086417a.jpg):

### Color Palette
Defined as CSS custom properties in [`EBWaterWebsite/css/styles.css`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/css/styles.css):
...
### Brand Imagery & Logos
* **Master Full Logo**: [`EBWaterWebsite/EBWaterLogo.jpg`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/EBWaterLogo.jpg) (2816×1536 px) — High-resolution centered logo featuring the interlocking jigsaw water droplet icon, the "EBWater" wordmark, and the subtitle *"WATER SAFETY & BIOLOGICAL RISK CONSULTANTS"*.
* **Square Icon**: [`EBWaterWebsite/assets/images/EBWaterLogoSquare.jpg`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/assets/images/EBWaterLogoSquare.jpg) (1100×1100 px) — Isolated jigsaw droplet emblem.
* **Vector Icon**: [`EBWaterWebsite/assets/icons/logo.svg`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/assets/icons/logo.svg) — SVG vector version of the jigsaw water droplet.
...
└── EBWaterWebsite\
    ...
    ├── index.html                     # Holding / Coming Soon page
...
## 4. Backend Endpoints & Integrations ([`server.js`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/server.js))
...
1. `POST /api/submit-enquiry`:
   * **Source**: Contact form on [`contact.html`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/contact.html).
   * **Payload**: `name`, `organisation`, `email`, `phone`, `enquiry`, `message`.
   * **Recipient**: `elaine@ebwater.co.uk`.
2. `POST /api/submit-consultation`:
   * **Source**: Consultation request form on [`consultation.html`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/consultation.html).
...
* **Interactive Elements** ([`EBWaterWebsite/js/main.js`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/js/main.js)):
...
* **Layouts & Responsiveness** ([`EBWaterWebsite/css/styles.css`](file:///C:/Users/Elaine/EBWWebsite/EBWaterWebsite/css/styles.css)):
